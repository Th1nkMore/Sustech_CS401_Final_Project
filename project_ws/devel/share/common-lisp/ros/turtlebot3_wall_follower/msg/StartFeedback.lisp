...
(cl:in-package turtlebot3_wall_follower-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <StartFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StartFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot3_wall_follower-msg:<StartFeedback> is deprecated: use turtlebot3_wall_follower-msg:StartFeedback instead.")))

(cl:ensure-generic-function 'current_distance-val :lambda-list '(m))
(cl:defmethod current_distance-val ((m <StartFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_wall_follower-msg:current_distance-val is deprecated.  Use turtlebot3_wall_follower-msg:current_distance instead.")
  (current_distance m))

(cl:ensure-generic-function 'current_error-val :lambda-list '(m))
(cl:defmethod current_error-val ((m <StartFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_wall_follower-msg:current_error-val is deprecated.  Use turtlebot3_wall_follower-msg:current_error instead.")
  (current_error m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StartFeedback>)))
  ...
  "turtlebot3_wall_follower/StartFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartFeedback)))
  "Returns string type for a message object of type 'StartFeedback"
  "turtlebot3_wall_follower/StartFeedback")
